...
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::imbue
...
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::overflow
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::pbackfail
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::setbuf
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::showmanyc
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::sync
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::underflow
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::xsgetn
#include <fstream> // std::basic_filebuf<char, std::char_traits<char> >::xsputn
#include <fstream> // std::basic_ifstream
#include <fstream> // std::basic_ifstream<char, std::char_traits<char> >::basic_ifstream
#include <fstream> // std::basic_ifstream<char, std::char_traits<char> >::close
#include <fstream> // std::basic_ifstream<char, std::char_traits<char> >::is_open
#include <fstream> // std::basic_ifstream<char, std::char_traits<char> >::open
#include <fstream> // std::basic_ifstream<char, std::char_traits<char> >::operator=
#include <fstream> // std::basic_ifstream<char, std::char_traits<char> >::rdbuf
...
{
	std::cout << "B143_[std::filebuf] ";
	{ // std::basic_filebuf file:bits/fstream.tcc line:1053
		pybind11::class_<std::filebuf, std::shared_ptr<std::filebuf>, PyCallBack_filebuf, std::streambuf> cl(M("std"), "filebuf", "");
		pybind11::handle cl_type = cl;

		cl.def( pybind11::init( [](){ return new std::filebuf(); }, [](){ return new PyCallBack_filebuf(); } ) );
		cl.def( pybind11::init( [](PyCallBack_filebuf const &o){ return new PyCallBack_filebuf(o); } ) );
		cl.def( pybind11::init( [](std::filebuf const &o){ return new std::filebuf(o); } ) );
		...
		cl.def("assign", (class std::basic_filebuf<char> & (std::filebuf::*)(const class std::basic_filebuf<char> &)) &std::basic_filebuf<char, std::char_traits<char> >::operator=, "C++: std::basic_filebuf<char, std::char_traits<char> >::operator=(const class std::basic_filebuf<char> &) --> class std::basic_filebuf<char> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	...
	{ // std::basic_ifstream file:bits/fstream.tcc line:1054
		...
		cl.def( pybind11::init( [](std::ifstream const &o){ return new std::ifstream(o); } ) );
		...
		cl.def("assign", (class std::basic_ifstream<char> & (std::ifstream::*)(const class std::basic_ifstream<char> &)) &std::basic_ifstream<char, std::char_traits<char> >::operator=, "C++: std::basic_ifstream<char, std::char_traits<char> >::operator=(const class std::basic_ifstream<char> &) --> class std::basic_ifstream<char> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
