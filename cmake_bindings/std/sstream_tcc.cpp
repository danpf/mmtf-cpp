...
#include <locale> // std::locale::locale
#include <locale> // std::locale::name
#include <locale> // std::locale::operator!=
#include <locale> // std::locale::operator=
#include <locale> // std::locale::operator==
...
#include <sstream> // std::__cxx11::basic_istringstream<char, std::char_traits<char>, std::allocator<char> >::basic_istringstream
#include <sstream> // std::__cxx11::basic_istringstream<char, std::char_traits<char>, std::allocator<char> >::operator=
#include <sstream> // std::__cxx11::basic_istringstream<char, std::char_traits<char>, std::allocator<char> >::rdbuf
#include <sstream> // std::__cxx11::basic_istringstream<char, std::char_traits<char>, std::allocator<char> >::str
#include <sstream> // std::__cxx11::basic_ostringstream
#include <sstream> // std::__cxx11::basic_ostringstream<char, std::char_traits<char>, std::allocator<char> >::basic_ostringstream
#include <sstream> // std::__cxx11::basic_ostringstream<char, std::char_traits<char>, std::allocator<char> >::operator=
#include <sstream> // std::__cxx11::basic_ostringstream<char, std::char_traits<char>, std::allocator<char> >::rdbuf
#include <sstream> // std::__cxx11::basic_ostringstream<char, std::char_traits<char>, std::allocator<char> >::str
#include <sstream> // std::__cxx11::basic_stringbuf
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::basic_stringbuf
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::operator=
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::overflow
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::pbackfail
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::setbuf
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::showmanyc
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::str
#include <sstream> // std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::underflow
#include <sstream> // std::__cxx11::basic_stringstream
#include <sstream> // std::__cxx11::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::basic_stringstream
#include <sstream> // std::__cxx11::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::operator=
#include <sstream> // std::__cxx11::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::rdbuf
#include <sstream> // std::__cxx11::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::str
...
#include <streambuf> // std::basic_streambuf<char, std::char_traits<char> >::imbue
...
#include <streambuf> // std::basic_streambuf<char, std::char_traits<char> >::sync
#include <streambuf> // std::basic_streambuf<char, std::char_traits<char> >::uflow
#include <streambuf> // std::basic_streambuf<char, std::char_traits<char> >::xsgetn
#include <streambuf> // std::basic_streambuf<char, std::char_traits<char> >::xsputn
...
struct PyCallBack_stringbuf : public std::stringbuf {
...
{
	std::cout << "B94_[std::stringbuf] ";
	{ // std::basic_stringbuf file:bits/sstream.tcc line:291
		pybind11::class_<std::stringbuf, std::shared_ptr<std::stringbuf>, PyCallBack_stringbuf, std::streambuf> cl(M("std"), "stringbuf", "");
		pybind11::handle cl_type = cl;

		cl.def( pybind11::init( [](){ return new std::stringbuf(); }, [](){ return new PyCallBack_stringbuf(); } ), "doc");
		cl.def( pybind11::init<enum std::_Ios_Openmode>(), pybind11::arg("__mode") );

		cl.def( pybind11::init( [](const class std::__cxx11::basic_string<char> & a0){ return new std::stringbuf(a0); }, [](const class std::__cxx11::basic_string<char> & a0){ return new PyCallBack_stringbuf(a0); } ), "doc");
		cl.def( pybind11::init<const class std::__cxx11::basic_string<char> &, enum std::_Ios_Openmode>(), pybind11::arg("__str"), pybind11::arg("__mode") );

		cl.def( pybind11::init( [](PyCallBack_stringbuf const &o){ return new PyCallBack_stringbuf(o); } ) );
		cl.def( pybind11::init( [](std::stringbuf const &o){ return new std::stringbuf(o); } ) );
		...
		cl.def("str", (void (std::stringbuf::*)(const std::string &)) &std::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::str, "C++: std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::str(const class std::__cxx11::basic_string<char> &) --> void", pybind11::arg("__s"));
		cl.def("assign", (class std::basic_stringbuf<char> & (std::stringbuf::*)(const class std::basic_stringbuf<char> &)) &std::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::operator=, "C++: std::__cxx11::basic_stringbuf<char, std::char_traits<char>, std::allocator<char> >::operator=(const class std::__cxx11::basic_stringbuf<char> &) --> class std::basic_stringbuf<char> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	...
	std::cout << "B95_[std::istringstream] ";
	std::cout << "B96_[std::ostringstream] ";
	std::cout << "B97_[std::stringstream] ";
	{ // std::basic_stringstream file:bits/sstream.tcc line:294
		...
		cl.def( pybind11::init<const class std::__cxx11::basic_string<char> &, enum std::_Ios_Openmode>(), pybind11::arg("__str"), pybind11::arg("__m") );

		cl.def( pybind11::init( [](std::stringstream const &o){ return new std::stringstream(o); } ) );
		...
		cl.def("str", (void (std::stringstream::*)(const std::string &)) &std::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::str, "C++: std::__cxx11::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::str(const class std::__cxx11::basic_string<char> &) --> void", pybind11::arg("__s"));
		cl.def("assign", (class std::basic_stringstream<char> & (std::stringstream::*)(const class std::basic_stringstream<char> &)) &std::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::operator=, "C++: std::__cxx11::basic_stringstream<char, std::char_traits<char>, std::allocator<char> >::operator=(const class std::__cxx11::basic_stringstream<char> &) --> class std::basic_stringstream<char> &", pybind11::return_value_policy::automatic, pybind11::arg(""));
