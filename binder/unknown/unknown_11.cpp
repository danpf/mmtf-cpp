...
{
	std::cout << "B263_[class std::vector<int, class std::allocator<int> > mmtf::(anonymous namespace)::convertFloatsToInts(const class std::vector<float, class std::allocator<float> > &, int)] ";
	// mmtf::(anonymous namespace)::convertFloatsToInts(const class std::vector<float, class std::allocator<float> > &, int) file: line:37
	...
	std::cout << "B264_[class std::vector<int, class std::allocator<int> > mmtf::(anonymous namespace)::deltaEncode(const class std::vector<int, class std::allocator<int> > &)] ";
	// mmtf::(anonymous namespace)::deltaEncode(const class std::vector<int, class std::allocator<int> > &) file: line:45
	...
	std::cout << "B265_[class std::vector<int, class std::allocator<int> > mmtf::(anonymous namespace)::runLengthEncode(const class std::vector<int, class std::allocator<int> > &)] ";
	// mmtf::(anonymous namespace)::runLengthEncode(const class std::vector<int, class std::allocator<int> > &) file: line:53
	...
	std::cout << "B266_[class std::vector<int, class std::allocator<int> > mmtf::(anonymous namespace)::recursiveIndexEncode(const class std::vector<int, class std::allocator<int> > &, int, int)] ";
	// mmtf::(anonymous namespace)::recursiveIndexEncode(const class std::vector<int, class std::allocator<int> > &, int, int) file: line:62
	...
	std::cout << "B267_[class std::vector<int, class std::allocator<int> > mmtf::(anonymous namespace)::convertCharsToInts(const class std::vector<char, class std::allocator<char> > &)] ";
	// mmtf::(anonymous namespace)::convertCharsToInts(const class std::vector<char, class std::allocator<char> > &) file: line:70
	...
	std::cout << "B268_[void mmtf::(anonymous namespace)::add_header(class std::__cxx11::basic_stringstream<char> &, unsigned int, unsigned int, unsigned int)] ";
	// mmtf::(anonymous namespace)::add_header(class std::__cxx11::basic_stringstream<char> &, unsigned int, unsigned int, unsigned int) file: line:80
	...
	M("mmtf::(anonymous namespace)").def("add_header", (void (*)(class std::basic_stringstream<char> &, unsigned int, unsigned int, unsigned int)) &mmtf::(anonymous namespace)::add_header, "Add mmtf header to a stream\n \n\n            stringstream to add a header to\n \n\n    size of array you're adding\n \n\n         the codec type number you're using to encode\n \n\n         the param for the codec you're using (default 0)\n\nC++: mmtf::(anonymous namespace)::add_header(class std::__cxx11::basic_stringstream<char> &, unsigned int, unsigned int, unsigned int) --> void", pybind11::arg("ss"), pybind11::arg("array_size"), pybind11::arg("codec"), pybind11::arg("param"));

	std::cout << "B269_[class std::vector<char, class std::allocator<char> > mmtf::(anonymous namespace)::stringstreamToCharVector(class std::__cxx11::basic_stringstream<char> &)] ";
	// mmtf::(anonymous namespace)::stringstreamToCharVector(class std::__cxx11::basic_stringstream<char> &) file: line:87
	M("mmtf::(anonymous namespace)").def("stringstreamToCharVector", (class std::vector<char, class std::allocator<char> > (*)(class std::basic_stringstream<char> &)) &mmtf::(anonymous namespace)::stringstreamToCharVector, "Convert stringstream to CharVector\n \n\n            ss to convert\n \n\n                  converted ss\n\nC++: mmtf::(anonymous namespace)::stringstreamToCharVector(class std::__cxx11::basic_stringstream<char> &) --> class std::vector<char, class std::allocator<char> >", pybind11::arg("ss"));
