...
{
	std::cout << "B205_[class std::__cxx11::basic_string<char> mmtf::getVersionString()] ";
	// mmtf::getVersionString() file: line:36
	...
	std::cout << "B206_[bool mmtf::isVersionSupported(const class std::__cxx11::basic_string<char> &)] ";
	// mmtf::isVersionSupported(const class std::__cxx11::basic_string<char> &) file: line:42
	M("mmtf").def("isVersionSupported", (bool (*)(const std::string &)) &mmtf::isVersionSupported, "Check if version is supported (minor revisions ok, major ones not)\n \n\n true if supported, false if not\n\nC++: mmtf::isVersionSupported(const class std::__cxx11::basic_string<char> &) --> bool", pybind11::arg("version_string"));

	std::cout << "B207_[mmtf::GroupType] ";
	{ // mmtf::GroupType file: line:49
	...
	std::cout << "B208_[mmtf::Entity] ";
	{ // mmtf::Entity file: line:77
	...
	std::cout << "B209_[mmtf::Transform] ";
	{ // mmtf::Transform file: line:103
	...
	std::cout << "B210_[mmtf::BioAssembly] ";
	{ // mmtf::BioAssembly file: line:126
	...
	std::cout << "B211_[mmtf::StructureData] ";
	{ // mmtf::StructureData file: line:151
		...
		cl.def_readwrite("extraData", &mmtf::StructureData::extraData);
	...
	std::cout << "B212_[float mmtf::getDefaultValue<float>()] ";
	// mmtf::getDefaultValue() file: line:373
	M("mmtf").def("getDefaultValue", (float (*)()) &mmtf::getDefaultValue<float>, "C++: mmtf::getDefaultValue() --> float");

	std::cout << "B213_[bool mmtf::isDefaultValue<std::vector<std::string, std::allocator<std::string > >>(const class std::vector<class std::__cxx11::basic_string<char>, class std::allocator<class std::__cxx11::basic_string<char> > > &)] ";
	// mmtf::isDefaultValue(const class std::vector<class std::__cxx11::basic_string<char>, class std::allocator<class std::__cxx11::basic_string<char> > > &) file: line:376
	M("mmtf").def("isDefaultValue", (bool (*)(const class std::vector<std::string, class std::allocator<std::string > > &)) &mmtf::isDefaultValue<std::vector<std::string, std::allocator<std::string > >>, "C++: mmtf::isDefaultValue(const class std::vector<class std::__cxx11::basic_string<char>, class std::allocator<class std::__cxx11::basic_string<char> > > &) --> bool", pybind11::arg("value"));

	std::cout << "B214_[bool mmtf::isDefaultValue<std::vector<int, std::allocator<int> >>(const class std::vector<int, class std::allocator<int> > &)] ";
	// mmtf::isDefaultValue(const class std::vector<int, class std::allocator<int> > &) file: line:376
	...
	std::cout << "B215_[bool mmtf::isDefaultValue<std::vector<char, std::allocator<char> >>(const class std::vector<char, class std::allocator<char> > &)] ";
	// mmtf::isDefaultValue(const class std::vector<char, class std::allocator<char> > &) file: line:376
	...
	std::cout << "B216_[bool mmtf::isDefaultValue<std::vector<float, std::allocator<float> >>(const class std::vector<float, class std::allocator<float> > &)] ";
	// mmtf::isDefaultValue(const class std::vector<float, class std::allocator<float> > &) file: line:376
	...
	std::cout << "B217_[bool mmtf::isDefaultValue<std::vector<signed char, std::allocator<signed char> >>(const class std::vector<signed char, class std::allocator<signed char> > &)] ";
	// mmtf::isDefaultValue(const class std::vector<signed char, class std::allocator<signed char> > &) file: line:376
	...
	std::cout << "B218_[bool mmtf::isDefaultValue<float>(const float &)] ";
	// mmtf::isDefaultValue(const float &) file: line:376
	...
	std::cout << "B219_[bool mmtf::isDefaultValue<std::vector<mmtf::BioAssembly, std::allocator<mmtf::BioAssembly> >>(const class std::vector<struct mmtf::BioAssembly, class std::allocator<struct mmtf::BioAssembly> > &)] ";
	// mmtf::isDefaultValue(const class std::vector<struct mmtf::BioAssembly, class std::allocator<struct mmtf::BioAssembly> > &) file: line:376
