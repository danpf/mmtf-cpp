...
void bind_std_stl_vector(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // std::vector file:bits/stl_vector.h line:216
		...
		cl.def( pybind11::init( [](class std::initializer_list<char> const & a0){ return new std::vector<char>(a0); } ), "doc");
		cl.def( pybind11::init<class std::initializer_list<char>, const class std::allocator<char> &>(), pybind11::arg("__l"), pybind11::arg("__a") );

		cl.def("get_allocator", [](std::vector<char> const &o) -> std::allocator<char> { return o.get_allocator(); }, "");
		...
		cl.def("assign", (class std::vector<char, class std::allocator<char> > & (std::vector<char>::*)(class std::initializer_list<char>)) &std::vector<char, std::allocator<char> >::operator=, "C++: std::vector<char, std::allocator<char> >::operator=(class std::initializer_list<char>) --> class std::vector<char, class std::allocator<char> > &", pybind11::return_value_policy::automatic, pybind11::arg("__l"));
		...
		cl.def("assign", (void (std::vector<char>::*)(class std::initializer_list<char>)) &std::vector<char, std::allocator<char> >::assign, "C++: std::vector<char, std::allocator<char> >::assign(class std::initializer_list<char>) --> void", pybind11::arg("__l"));
		...
		cl.def("insert", (class __gnu_cxx::__normal_iterator<char *, class std::vector<char, class std::allocator<char> > > (std::vector<char>::*)(class __gnu_cxx::__normal_iterator<const char *, class std::vector<char, class std::allocator<char> > >, class std::initializer_list<char>)) &std::vector<char, std::allocator<char> >::insert, "C++: std::vector<char, std::allocator<char> >::insert(class __gnu_cxx::__normal_iterator<const char *, class std::vector<char, class std::allocator<char> > >, class std::initializer_list<char>) --> class __gnu_cxx::__normal_iterator<char *, class std::vector<char, class std::allocator<char> > >", pybind11::arg("__position"), pybind11::arg("__l"));
	...
	{ // std::vector file:bits/stl_vector.h line:216
		...
		cl.def( pybind11::init( [](class std::initializer_list<int> const & a0){ return new std::vector<int>(a0); } ), "doc");
		cl.def( pybind11::init<class std::initializer_list<int>, const class std::allocator<int> &>(), pybind11::arg("__l"), pybind11::arg("__a") );

		cl.def("get_allocator", [](std::vector<int> const &o) -> std::allocator<int> { return o.get_allocator(); }, "");
		...
		cl.def("assign", (class std::vector<int, class std::allocator<int> > & (std::vector<int>::*)(class std::initializer_list<int>)) &std::vector<int, std::allocator<int> >::operator=, "C++: std::vector<int, std::allocator<int> >::operator=(class std::initializer_list<int>) --> class std::vector<int, class std::allocator<int> > &", pybind11::return_value_policy::automatic, pybind11::arg("__l"));
		...
		cl.def("assign", (void (std::vector<int>::*)(class std::initializer_list<int>)) &std::vector<int, std::allocator<int> >::assign, "C++: std::vector<int, std::allocator<int> >::assign(class std::initializer_list<int>) --> void", pybind11::arg("__l"));
		...
		cl.def("insert", (class __gnu_cxx::__normal_iterator<int *, class std::vector<int, class std::allocator<int> > > (std::vector<int>::*)(class __gnu_cxx::__normal_iterator<const int *, class std::vector<int, class std::allocator<int> > >, class std::initializer_list<int>)) &std::vector<int, std::allocator<int> >::insert, "C++: std::vector<int, std::allocator<int> >::insert(class __gnu_cxx::__normal_iterator<const int *, class std::vector<int, class std::allocator<int> > >, class std::initializer_list<int>) --> class __gnu_cxx::__normal_iterator<int *, class std::vector<int, class std::allocator<int> > >", pybind11::arg("__position"), pybind11::arg("__l"));
