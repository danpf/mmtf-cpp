...
void bind_std_fstream_tcc_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // std::basic_ofstream file:bits/fstream.tcc line:1055
		...
		cl.def( pybind11::init<const class std::__cxx11::basic_string<char> &, enum std::_Ios_Openmode>(), pybind11::arg("__s"), pybind11::arg("__mode") );
		...
		cl.def("open", (void (std::ofstream::*)(const std::string &, enum std::_Ios_Openmode)) &std::basic_ofstream<char, std::char_traits<char> >::open, "C++: std::basic_ofstream<char, std::char_traits<char> >::open(const class std::__cxx11::basic_string<char> &, enum std::_Ios_Openmode) --> void", pybind11::arg("__s"), pybind11::arg("__mode"));
	...
	std::cout << "B255_[std::basic_fstream<char,std::char_traits<char>>] ";
	std::cout << "B256_[std::basic_filebuf<wchar_t,std::char_traits<wchar_t>>] ";
	std::cout << "B257_[std::basic_ifstream<wchar_t,std::char_traits<wchar_t>>] ";
	std::cout << "B258_[std::basic_ofstream<wchar_t,std::char_traits<wchar_t>>] ";
	std::cout << "B259_[std::basic_fstream<wchar_t,std::char_traits<wchar_t>>] ";
}
