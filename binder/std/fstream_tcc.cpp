...
void bind_std_fstream_tcc(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // std::basic_ifstream file:bits/fstream.tcc line:1054
		...
		cl.def("open", (void (std::ifstream::*)(const std::string &, enum std::_Ios_Openmode)) &std::basic_ifstream<char, std::char_traits<char> >::open, "C++: std::basic_ifstream<char, std::char_traits<char> >::open(const class std::__cxx11::basic_string<char> &, enum std::_Ios_Openmode) --> void", pybind11::arg("__s"), pybind11::arg("__mode"));
