...
{
	std::cout << "B174_[std::basic_ios<char,std::char_traits<char>>] ";
	...
	std::cout << "B175_[std::basic_ios<wchar_t,std::char_traits<wchar_t>>] ";
	std::cout << "B176_[class std::basic_ostream<char> & std::endl<char,std::char_traits<char>>(class std::basic_ostream<char> &)] ";
	std::cout << "B177_[class std::basic_ostream<wchar_t> & std::endl<wchar_t,std::char_traits<wchar_t>>(class std::basic_ostream<wchar_t> &)] ";
	std::cout << "B178_[class std::basic_ostream<char> & std::ends<char,std::char_traits<char>>(class std::basic_ostream<char> &)] ";
	std::cout << "B179_[class std::basic_ostream<wchar_t> & std::ends<wchar_t,std::char_traits<wchar_t>>(class std::basic_ostream<wchar_t> &)] ";
	std::cout << "B180_[class std::basic_ostream<char> & std::flush<char,std::char_traits<char>>(class std::basic_ostream<char> &)] ";
	std::cout << "B181_[class std::basic_ostream<wchar_t> & std::flush<wchar_t,std::char_traits<wchar_t>>(class std::basic_ostream<wchar_t> &)] ";
	std::cout << "B182_[class std::basic_ostream<char> & std::__is_convertible_to_basic_ostream_test<char,std::char_traits<char>>(class std::basic_ostream<char> *)] ";
	std::cout << "B183_[std::__is_convertible_to_basic_ostream_impl<std::ostream &,void>] ";
	std::cout << "B184_[std::__is_convertible_to_basic_ostream_impl<std::basic_stringstream<char> &,void>] ";
	std::cout << "B185_[std::__is_convertible_to_basic_ostream_impl<std::basic_ostringstream<char> &,void>] ";
	std::cout << "B186_[std::__is_convertible_to_basic_ostream<std::ostream &>] ";
	std::cout << "B187_[std::__is_convertible_to_basic_ostream<std::basic_stringstream<char> &>] ";
	std::cout << "B188_[std::__is_convertible_to_basic_ostream<std::basic_ostringstream<char> &>] ";
	std::cout << "B189_[std::ostream] ";
